...
public class MTS {
    public static void main(String[] args) {
        ...
        checkPaymentSystemLogos(driver);
        checkMoreInfoLink(driver);
        checkContinueButtonEmptyFields(driver);
        checkContinueButtonOnlyEmail(driver);
        checkContinueButtonValidData(driver);
    ...
    private static void checkPaymentSystemLogos(WebDriver driver) {
    ...
    public static void checkContinueButtonEmptyFields(WebDriver driver) {
        driver.get("https://mts.by");
    ...
    public static void checkContinueButtonOnlyEmail(WebDriver driver) {
        WebElement phoneField = driver.findElement(By.xpath("//form[@id='pay-connection']//input[@id='connection-phone']"));
    ...
    private static void checkContinueButtonValidData(WebDriver driver) {
        WebElement phoneField = driver.findElement(By.xpath("//form[@id='pay-connection']//input[@id='connection-phone']"));
